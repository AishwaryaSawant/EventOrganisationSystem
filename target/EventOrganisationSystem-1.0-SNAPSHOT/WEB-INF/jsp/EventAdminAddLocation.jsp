<%-- 
    Document   : EventAdminAddLocation
    Created on : Apr 16, 2020, 11:38:42 PM
    Author     : aishw
--%>
...
<html>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-collapse navbar-expand-lg">
      ...
      <a class="navbar-brand" href="#">
        ...
        <h1>Add Location</h1>
        <form action="EventAdminAddedLoc.htm" method="post">
            <div class="row">
          <div class="form-group col-md-4">
            <label for="location">Location </label>
            <input type="text" name="location" id="location" placeholder="state" required/>
          </div>
        </div>
