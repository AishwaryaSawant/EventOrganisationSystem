<%-- 
    Document   : EventOrderFoodSelect
    Created on : Apr 18, 2020, 12:36:41 PM
    Author     : aishw
--%>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-collapse navbar-expand-lg">
      ...
      <a class="navbar-brand" href="#">
        ...
        <table border="2" width="400"><tr><th colspan="2">
                    <h1>Select Food</h1></th><tr><td>
        <form method="post" action="EventOrderFoodSelected.htm" name="abc">
        <div class="row">
          <div class="form-group col-md-4">
            ...
            <select name="foodname" id="foodname" size="10" multiple>
                <c:forEach items="${listFood}" var="food">
                    <option value="${food.oid}">${food.foodname} | ${food.foodtype} | ${food.servecapacity} | ${food.price}</option>
                </c:forEach>
            </select>
