<%-- 
    ...
    Created on : Apr 17, 2020, 7:20:04 PM
    Author     : aishw
--%>
...
<html>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-collapse navbar-expand-lg">
      ...
      <a class="navbar-brand" href="#">
        ...
        <h1>Select from available venues:</h1>
<!--        <form action="EventOrderVenueSelected" method="post">-->
       <table border="2">
            <tr>
             <th>Venue Name</th>
             <th>Location</th>
            ...
            <c:forEach var="venue" items="${venlist}">
                    <tr>
                    ...
                    <td>
                        <a href="EventOrderVenueSelected.htm?id=${venue.getOid()}">Select Venue</a>
...
<!--                <button onclick="window.location.href = 'EventVenueUp.htm?id=${venue.getOid()}';">Submit</button>-->
<!--        </form>-->
    </body>
</html>
